...
| sincere | adj. | /sɪnˈsɪə(r)/ | 真诚的；诚挚的；诚恳的；诚实的；坦率的 |
...
| supervise | v. | /ˈsuːpəvaɪz/ | 监督；管理；指导；主管 |
...
| thrive | v. | /θraɪv/ | 繁荣；蓬勃发展；茁壮成长；兴旺发达；旺盛 |
...
| transparency | v. | /trænsˈpærənsi/ | 透明；透明度；透明性；幻灯片；显而易见；易懂；一目了然；透明正片 |
...
| tutorial | adj. | /tjuˈtɔːr.i.əl/ | 指导的，教程 |
